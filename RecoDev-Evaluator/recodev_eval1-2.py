...
#project_name
#new_issue_text
print "Welcome to RecoDev-Evaluator1-2!"

base_path = sys.argv[1]
project_name = sys.argv[2]
#new_issue_text = sys.argv[3]

print "#1-2. Evaluation of the content-based recommendation engine using single-label (normal) classification, recommending the top-3 developers..."
