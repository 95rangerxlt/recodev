...
print "The similarity measure of the collaborative engines uses not only the Cosine similarity measure, but also the information of the CC lists of bug reports..."
