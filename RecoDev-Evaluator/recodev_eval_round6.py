...
#project_name
#new_issue_text
print "Welcome to RecoDev-Evaluator6!"

base_path = sys.argv[1]
project_name = sys.argv[2]
#new_issue_text = sys.argv[3]

print "Round 6. Evaluation of the content-based recommendation engine using ***multi-label classification***, recommending the top-3 developers..."
